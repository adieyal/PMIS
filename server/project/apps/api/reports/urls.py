...
urlpatterns = patterns('project.apps.api.reports',
    ...
    url(r'^cluster/dashboard/(?P<year>\d+)/(?P<month>\d+)/$', 'cluster_report.cluster_dashboard', name='cluster_dashboard'),
    url(r'^cluster/progress/(?P<year>\d+)/(?P<month>\d+)/$', 'cluster_report.cluster_progress', name='cluster_progress'),
    url(r'^cluster/performance/(?P<year>\d+)/(?P<month>\d+)/$', 'cluster_report.cluster_performance', name='cluster_performance'),
)
