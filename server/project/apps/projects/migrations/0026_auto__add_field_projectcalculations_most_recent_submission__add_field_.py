...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectCalculations.most_recent_submission'
        db.add_column(u'projects_projectcalculations', 'most_recent_submission',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.MonthlySubmission'], null=True),
                      keep_default=False)

        # Adding field 'MonthlySubmission.jobs_created'
        db.add_column(u'projects_monthlysubmission', 'jobs_created',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectCalculations.most_recent_submission'
        db.delete_column(u'projects_projectcalculations', 'most_recent_submission_id')

        # Deleting field 'MonthlySubmission.jobs_created'
        db.delete_column(u'projects_monthlysubmission', 'jobs_created')
    ...
    models = {
        ...
        u'projects.monthlysubmission': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 21, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jobs_created': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
        ...
        u'projects.projectcalculations': {
            'Meta': {'object_name': 'ProjectCalculations'},
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 21, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_bad': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'most_recent_submission': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['projects.MonthlySubmission']", 'null': 'True'}),
            'performance': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'calculations'", 'to': u"orm['projects.Project']"})
        },
        u'projects.projectfinancial': {
            'Meta': {'object_name': 'ProjectFinancial'},
            'final_accounts': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
