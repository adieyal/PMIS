...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScopeOfWork.description'
        db.add_column(u'projects_scopeofwork', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScopeOfWork.description'
        db.delete_column(u'projects_scopeofwork', 'description')
