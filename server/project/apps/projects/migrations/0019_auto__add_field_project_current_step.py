...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.current_step'
        db.add_column(u'projects_project', 'current_step',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Milestone'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.current_step'
        db.delete_column(u'projects_project', 'current_step_id')
    ...
    models = {
        ...
        u'projects.monthlysubmission': {
            'Meta': {'unique_together': "(('project', 'month', 'year'),)", 'object_name': 'MonthlySubmission'},
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'month': ('django.db.models.fields.CharField', [], {'default': '7', 'max_length': '255'}),
        ...
        u'projects.planning': {
            'Meta': {'unique_together': "(('project', 'month', 'year'),)", 'object_name': 'Planning'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
