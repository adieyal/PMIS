...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectCalculations'
        db.create_table(u'projects_projectcalculations', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 16, 0, 0))),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='calculations', to=orm['projects.Project'])),
            ('is_bad', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'projects', ['ProjectCalculations'])


    def backwards(self, orm):
        # Deleting model 'ProjectCalculations'
        db.delete_table(u'projects_projectcalculations')
    ...
    models = {
        ...
        u'projects.monthlysubmission': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 16, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
