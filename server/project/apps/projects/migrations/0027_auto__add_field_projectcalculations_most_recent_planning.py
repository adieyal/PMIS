...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectCalculations.most_recent_planning'
        db.add_column(u'projects_projectcalculations', 'most_recent_planning',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Planning'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectCalculations.most_recent_planning'
        db.delete_column(u'projects_projectcalculations', 'most_recent_planning_id')
