...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Milestone', fields ['phase', 'order']
        db.create_unique(u'projects_milestone', ['phase', 'order'])


    def backwards(self, orm):
        # Removing unique constraint on 'Milestone', fields ['phase', 'order']
        db.delete_unique(u'projects_milestone', ['phase', 'order'])
    ...
    models = {
        ...
        u'projects.projectmilestone': {
            ...
            'completion_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 27, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
