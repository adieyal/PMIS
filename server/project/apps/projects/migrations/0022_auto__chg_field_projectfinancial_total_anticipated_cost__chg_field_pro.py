...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectFinancial.total_anticipated_cost'
        db.alter_column(u'projects_projectfinancial', 'total_anticipated_cost', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'ProjectFinancial.previous_expenses'
        db.alter_column(u'projects_projectfinancial', 'previous_expenses', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Budget.allocated_budget'
        db.alter_column(u'projects_budget', 'allocated_budget', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Budget.allocated_planning_budget'
        db.alter_column(u'projects_budget', 'allocated_planning_budget', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'ProjectFinancial.total_anticipated_cost'
        db.alter_column(u'projects_projectfinancial', 'total_anticipated_cost', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2))

        # Changing field 'ProjectFinancial.previous_expenses'
        db.alter_column(u'projects_projectfinancial', 'previous_expenses', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2))

        # Changing field 'Budget.allocated_budget'
        db.alter_column(u'projects_budget', 'allocated_budget', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2))

        # Changing field 'Budget.allocated_planning_budget'
        db.alter_column(u'projects_budget', 'allocated_planning_budget', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2))
    ...
    models = {
        ...
        u'projects.budget': {
            ...
            'allocated_budget': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'allocated_planning_budget': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'projects.monthlysubmission': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 12, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'projects.projectfinancial': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'previous_expenses': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            ...
            'total_anticipated_cost': ('django.db.models.fields.FloatField', [], {'default': '0'})
        },
