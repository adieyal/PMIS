...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Planning.planned_expenses'
        raise RuntimeError("Cannot reverse this migration. 'Planning.planned_expenses' and its values cannot be restored.")
