...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectFinancial.previous_expenses'
        db.add_column(u'projects_projectfinancial', 'previous_expenses',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectFinancial.previous_expenses'
        db.delete_column(u'projects_projectfinancial', 'previous_expenses')
    ...
    models = {
        ...
        u'projects.projectfinancial': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'previous_expenses': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '20', 'decimal_places': '2'}),
