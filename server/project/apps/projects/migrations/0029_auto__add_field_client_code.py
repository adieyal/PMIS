...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Client.code'
        db.add_column(u'projects_client', 'code',
                      self.gf('django.db.models.fields.CharField')(default='DoH', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Client.code'
        db.delete_column(u'projects_client', 'code')
