...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ScopeOfWork.quantity'
        db.alter_column(u'projects_scopeofwork', 'quantity', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ScopeOfWork.quantity'
        raise RuntimeError("Cannot reverse this migration. 'ScopeOfWork.quantity' and its values cannot be restored.")
