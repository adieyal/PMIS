...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectCalculations.performance'
        db.add_column(u'projects_projectcalculations', 'performance',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectCalculations.performance'
        db.delete_column(u'projects_projectcalculations', 'performance')
