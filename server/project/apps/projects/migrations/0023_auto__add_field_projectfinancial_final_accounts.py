...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectFinancial.final_accounts'
        db.add_column(u'projects_projectfinancial', 'final_accounts',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectFinancial.final_accounts'
        db.delete_column(u'projects_projectfinancial', 'final_accounts')
