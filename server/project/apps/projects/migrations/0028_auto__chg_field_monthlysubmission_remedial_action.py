...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MonthlySubmission.remedial_action'
        db.alter_column(u'projects_monthlysubmission', 'remedial_action', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'MonthlySubmission.remedial_action'
        db.alter_column(u'projects_monthlysubmission', 'remedial_action', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        u'projects.monthlysubmission': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 3, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'remedial_action': ('django.db.models.fields.TextField', [], {'blank': 'True'})
        },
        ...
        u'projects.projectcalculations': {
            ...
            'most_recent_planning': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['projects.Planning']", 'null': 'True'}),
