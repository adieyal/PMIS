...
def district_dashboard(request, district_id, year, month):
    ...
    return TemplateResponse(request, 'reports/district/index.html', district_report_json2(district_id, year, month))

def district_progress(request, district_id, year, month):
    return TemplateResponse(request, 'reports/district/progress.html', district_report_json2(district_id, year, month))
