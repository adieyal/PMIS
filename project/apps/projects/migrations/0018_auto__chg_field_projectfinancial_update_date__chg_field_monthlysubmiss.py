...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectFinancial.update_date'
        db.alter_column(u'projects_projectfinancial', 'update_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'MonthlySubmission.update_date'
        db.alter_column(u'projects_monthlysubmission', 'update_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Budget.update_date'
        db.alter_column(u'projects_budget', 'update_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'ProjectMilestone.update_date'
        db.alter_column(u'projects_projectmilestone', 'update_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Planning.update_date'
        db.alter_column(u'projects_planning', 'update_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'ScopeOfWork.update_date'
        db.alter_column(u'projects_scopeofwork', 'update_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Project.update_date'
        db.alter_column(u'projects_project', 'update_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'VarianceOrder.update_date'
        db.alter_column(u'projects_varianceorder', 'update_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'ProjectStatus.update_date'
        db.alter_column(u'projects_projectstatus', 'update_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'ProjectFinancial.update_date'
        db.alter_column(u'projects_projectfinancial', 'update_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'MonthlySubmission.update_date'
        db.alter_column(u'projects_monthlysubmission', 'update_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Budget.update_date'
        db.alter_column(u'projects_budget', 'update_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ProjectMilestone.update_date'
        db.alter_column(u'projects_projectmilestone', 'update_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Planning.update_date'
        db.alter_column(u'projects_planning', 'update_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ScopeOfWork.update_date'
        db.alter_column(u'projects_scopeofwork', 'update_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Project.update_date'
        db.alter_column(u'projects_project', 'update_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'VarianceOrder.update_date'
        db.alter_column(u'projects_varianceorder', 'update_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ProjectStatus.update_date'
        db.alter_column(u'projects_projectstatus', 'update_date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'projects.projectmilestone': {
            ...
            'cid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'null': 'True', 'db_index': 'True'}),
            'completion_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 15, 0, 0)'}),
