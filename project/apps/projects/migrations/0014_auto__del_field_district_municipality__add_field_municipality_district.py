...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'District.municipality'
        db.delete_column(u'projects_district', 'municipality_id')

        # Adding field 'Municipality.district'
        db.add_column(u'projects_municipality', 'district',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='municipalities', to=orm['projects.District']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'District.municipality'
        raise RuntimeError("Cannot reverse this migration. 'District.municipality' and its values cannot be restored.")
        # Deleting field 'Municipality.district'
        db.delete_column(u'projects_municipality', 'district_id')
