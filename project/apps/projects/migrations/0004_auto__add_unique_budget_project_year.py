...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Budget', fields ['project', 'year']
        db.create_unique(u'projects_budget', ['project_id', 'year'])


    def backwards(self, orm):
        # Removing unique constraint on 'Budget', fields ['project', 'year']
        db.delete_unique(u'projects_budget', ['project_id', 'year'])
