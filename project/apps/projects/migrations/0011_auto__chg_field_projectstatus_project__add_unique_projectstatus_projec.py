...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectStatus.project'
        db.alter_column(u'projects_projectstatus', 'project_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['projects.Project'], unique=True))
        # Adding unique constraint on 'ProjectStatus', fields ['project']
        db.create_unique(u'projects_projectstatus', ['project_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProjectStatus', fields ['project']
        db.delete_unique(u'projects_projectstatus', ['project_id'])


        # Changing field 'ProjectStatus.project'
        db.alter_column(u'projects_projectstatus', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project']))
