...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Budget.year'
        db.alter_column(u'projects_budget', 'year', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'MonthlySubmission.month'
        db.alter_column(u'projects_monthlysubmission', 'month', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Budget.year'
        db.alter_column(u'projects_budget', 'year', self.gf('django.db.models.fields.DateField')())

        # Changing field 'MonthlySubmission.month'
        db.alter_column(u'projects_monthlysubmission', 'month', self.gf('django.db.models.fields.DateField')())
