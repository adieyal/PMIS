...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MonthlySubmission.project'
        db.alter_column(u'projects_monthlysubmission', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['projects.Project']))

    def backwards(self, orm):

        # Changing field 'MonthlySubmission.project'
        db.alter_column(u'projects_monthlysubmission', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['projects.Project']))
