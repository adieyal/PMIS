...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MonthlySubmission.actual_expenditure'
        db.alter_column(u'projects_monthlysubmission', 'actual_expenditure', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'MonthlySubmission.actual_progress'
        db.alter_column(u'projects_monthlysubmission', 'actual_progress', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'MonthlySubmission.actual_expenditure'
        db.alter_column(u'projects_monthlysubmission', 'actual_expenditure', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'MonthlySubmission.actual_progress'
        db.alter_column(u'projects_monthlysubmission', 'actual_progress', self.gf('django.db.models.fields.PositiveIntegerField')())
