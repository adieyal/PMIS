...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'projects_projectstatus', (
            ...
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_status', to=orm['projects.Project'])),
    ...
    models = {
        ...
        u'projects.projectstatus': {
            ...
            'cid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'null': 'True', 'db_index': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'project_status'", 'to': u"orm['projects.Project']"}),
