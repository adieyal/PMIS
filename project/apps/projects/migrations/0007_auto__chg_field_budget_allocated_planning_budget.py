...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Budget.allocated_planning_budget'
        raise RuntimeError("Cannot reverse this migration. 'Budget.allocated_planning_budget' and its values cannot be restored.")
