...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectMilestone.completion_date'
        db.alter_column(u'projects_projectmilestone', 'completion_date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'ProjectMilestone.completion_date'
        db.alter_column(u'projects_projectmilestone', 'completion_date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'projects.projectmilestone': {
            ...
            'completion_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 28, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
