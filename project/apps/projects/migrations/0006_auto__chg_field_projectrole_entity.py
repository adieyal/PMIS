...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectRole.entity'
        db.alter_column(u'projects_projectrole', 'entity_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['projects.Entity']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ProjectRole.entity'
        raise RuntimeError("Cannot reverse this migration. 'ProjectRole.entity' and its values cannot be restored.")
