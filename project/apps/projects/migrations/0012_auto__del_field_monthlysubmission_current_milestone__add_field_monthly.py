...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MonthlySubmission.current_milestone'
        db.delete_column(u'projects_monthlysubmission', 'current_milestone_id')

        # Adding field 'MonthlySubmission.project'
        db.add_column(u'projects_monthlysubmission', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='monthly_submissions', null=True, to=orm['projects.Project']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'MonthlySubmission.current_milestone'
        raise RuntimeError("Cannot reverse this migration. 'MonthlySubmission.current_milestone' and its values cannot be restored.")
        # Deleting field 'MonthlySubmission.project'
        db.delete_column(u'projects_monthlysubmission', 'project_id')
    ...
    models = {
        ...
        u'projects.monthlysubmission': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'monthly_submissions'", 'null': 'True', 'to': u"orm['projects.Project']"}),
