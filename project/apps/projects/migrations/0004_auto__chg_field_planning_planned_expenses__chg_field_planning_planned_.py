...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'projects_planning', 'planned_expenses', self.gf('django.db.models.fields.FloatField')(default=0))

        # Changing field 'Planning.planned_progress'
        db.alter_column(u'projects_planning', 'planned_progress', self.gf('django.db.models.fields.FloatField')(default=0))
