...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Project.municipality'
        raise RuntimeError("Cannot reverse this migration. 'Project.municipality' and its values cannot be restored.")
