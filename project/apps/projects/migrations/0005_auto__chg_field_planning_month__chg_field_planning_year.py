...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'projects_planning', 'month', self.gf('django.db.models.fields.CharField')(default=1, max_length=255))

        # Changing field 'Planning.year'
        db.alter_column(u'projects_planning', 'year', self.gf('django.db.models.fields.CharField')(default=1960, max_length=255))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Planning.year'
        db.alter_column(u'projects_planning', 'year', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
