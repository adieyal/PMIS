...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectMilestone.milestone'
        db.add_column(u'projects_projectmilestone', 'milestone',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='project_milestone', to=orm['projects.Milestone']),
                      keep_default=False)
