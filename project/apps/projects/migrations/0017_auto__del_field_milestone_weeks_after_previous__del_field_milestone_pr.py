...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Milestone.weeks_after_previous'
        db.delete_column(u'projects_milestone', 'weeks_after_previous')

        # Deleting field 'Milestone.project'
        db.delete_column(u'projects_milestone', 'project_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Milestone.weeks_after_previous'
        raise RuntimeError("Cannot reverse this migration. 'Milestone.weeks_after_previous' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Milestone.project'
        raise RuntimeError("Cannot reverse this migration. 'Milestone.project' and its values cannot be restored.")
