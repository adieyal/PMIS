...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProjectFinancial.project_planning_budget'
        db.delete_column(u'projects_projectfinancial', 'project_planning_budget')

        # Adding field 'Budget.allocated_planning_budget'
        db.add_column(u'projects_budget', 'allocated_planning_budget',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ProjectFinancial.project_planning_budget'
        raise RuntimeError("Cannot reverse this migration. 'ProjectFinancial.project_planning_budget' and its values cannot be restored.")
        # Deleting field 'Budget.allocated_planning_budget'
        db.delete_column(u'projects_budget', 'allocated_planning_budget')
