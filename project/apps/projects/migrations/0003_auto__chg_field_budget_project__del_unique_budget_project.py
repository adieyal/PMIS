...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Budget', fields ['project']
        db.delete_unique(u'projects_budget', ['project_id'])


        # Changing field 'Budget.project'
        db.alter_column(u'projects_budget', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project']))

    def backwards(self, orm):

        # Changing field 'Budget.project'
        db.alter_column(u'projects_budget', 'project_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['projects.Project']))
        # Adding unique constraint on 'Budget', fields ['project']
        db.create_unique(u'projects_budget', ['project_id'])
    ...
    models = {
        ...
        u'projects.projectmilestone': {
            ...
            'completion_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 28, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
