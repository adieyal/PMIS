...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MonthlySubmission.comment_type'
        db.alter_column(u'projects_monthlysubmission', 'comment_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['projects.CommentType']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'MonthlySubmission.comment_type'
        raise RuntimeError("Cannot reverse this migration. 'MonthlySubmission.comment_type' and its values cannot be restored.")
    ...
    models = {
        ...
        u'projects.projectmilestone': {
            ...
            'completion_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 20, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
