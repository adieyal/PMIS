...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.new_municipality'
        db.delete_column(u'projects_project', 'new_municipality_id')

        # Adding field 'Project.municipality'
        db.add_column(u'projects_project', 'municipality',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='projects', null=True, to=orm['projects.Municipality']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Project.new_municipality'
        db.add_column(u'projects_project', 'new_municipality',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='new_projects', null=True, to=orm['projects.Municipality']),
                      keep_default=False)

        # Deleting field 'Project.municipality'
        db.delete_column(u'projects_project', 'municipality_id')
    ...
    models = {
        ...
        u'projects.monthlysubmission': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'month': ('django.db.models.fields.CharField', [], {'default': '6', 'max_length': '255'}),
        ...
        u'projects.projectmilestone': {
            ...
            'completion_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime.now'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
