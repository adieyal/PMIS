...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Planning.planned_expanses'
        db.delete_column(u'projects_planning', 'planned_expanses')
        ...
        # Adding field 'Planning.planned_expenses'
        db.add_column(u'projects_planning', 'planned_expenses',
        ...
        # Changing field 'Planning.month'
        db.alter_column(u'projects_planning', 'month', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Planning.planned_expanses'
        raise RuntimeError("Cannot reverse this migration. 'Planning.planned_expanses' and its values cannot be restored.")
        # Deleting field 'Planning.year'
        db.delete_column(u'projects_planning', 'year')

        # Deleting field 'Planning.planned_expenses'
        db.delete_column(u'projects_planning', 'planned_expenses')


        # User chose to not deal with backwards NULL issues for 'Planning.planned_progress'
        raise RuntimeError("Cannot reverse this migration. 'Planning.planned_progress' and its values cannot be restored.")
    ...
    models = {
        ...
        u'projects.planning': {
            ...
            'planned_expenses': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'planned_progress': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
