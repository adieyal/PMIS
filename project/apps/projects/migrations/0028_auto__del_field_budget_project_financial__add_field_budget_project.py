...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Budget.project_financial'
        db.delete_column(u'projects_budget', 'project_financial_id')

        # Adding field 'Budget.project'
        db.add_column(u'projects_budget', 'project',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=0, related_name='budgets', unique=True, to=orm['projects.Project']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Budget.project_financial'
        raise RuntimeError("Cannot reverse this migration. 'Budget.project_financial' and its values cannot be restored.")
        # Deleting field 'Budget.project'
        db.delete_column(u'projects_budget', 'project_id')
