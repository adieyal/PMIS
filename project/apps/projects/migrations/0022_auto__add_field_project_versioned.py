...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.versioned'
        db.add_column(u'projects_project', 'versioned',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['projects.Versioned']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.versioned'
        db.delete_column(u'projects_project', 'versioned_id')
    ...
    models = {
        ...
        u'projects.project': {
            ...
            'versioned': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['projects.Versioned']"})
        },
